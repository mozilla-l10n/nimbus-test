...
class Linter(visitor.Visitor):
    ...
    def visit_Attribute(self, node):
        self.add_error(node, "SY06", "Attributes are not supported.")
        pass
    ...
    def visit_Term(self, node):
        ...
        self.add_error(node, "SY02", "Terms are not supported.")
    ...
    def visit_MessageReference(self, node):
        self.add_error(node, "SY03", "Message references are not supported.")
        pass

    def visit_TermReference(self, node):
        self.add_error(node, "SY04", "Term references are not supported.")
        pass
    ...
    def visit_SelectExpression(self, node):
        if node.variants:
            self.add_error(node, "SY05", "Variants are not supported.")
        pass
